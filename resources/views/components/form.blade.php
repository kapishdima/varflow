<form class="form">
    <div class="form__item1">
        ...
        <input class="input" placeholder="Ваше имя" id="number" name="number" />
    </div>
    ...
    <div class="form__item5">
        ...
        <div>
            <textarea class="input textarea" placeholder="Расскажите подробнее о проекте" name="" id="" cols="30" rows="10"></textarea>
        </div>
    </div>
    <div class="form__item6">
        <button id="startProjectBtn" class="link form__button" type="submit">Начать проект
