<div class="offer-section offer-section--desktop">
    <div class="offer-section__wrapper">
        <div class="offer-section__block offer-section__block--left">
            ...
            <a href="#contact-form" class="link offer-section__link">@lang('default.start_project_text')
...
<div class="offer-section offer-section--mobile">
    <div class="offer-section__name">
        <h2 class="offer-section__font offer-section__font--company">varflow</h2>
        <h1 class="offer-section__font offer-section__font--about">Creative agency</р>
    </div>
    <div class="offer-section__block">
        @include('components.console')
    </div>
    <a href="#contact-form" class="link offer-section__link">@lang('default.start_project_text')
        <span class="link__icon offer-section__link--icon">
